...
import { SendinvitationComponent } from 'src/app/pages/invitation/sendinvitation/sendinvitation.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path :'invitation', component: SendinvitationComponent ,canActivate: [AuthGuard] }
